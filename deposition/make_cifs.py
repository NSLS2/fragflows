...
def make_changed_state_sf_cif(
    ...
    try:
        REFINEMENT_SF_CIF = table1.loc[table1['xtal_id'] == xtal_id,'refined_reflection_file'].iloc[0]
...
def make_changed_state_cif(
    ...
    doc = gemmi.cif.Document()
    print(xtal_id)
    structure_cif = table1.loc[table1['xtal_id'] == xtal_id,'refined_structure_file'].iloc[0]
